...
class TransactionVerificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TransactionVerification = channel.unary_unary(
                '/verify.TransactionVerificationService/TransactionVerification',
...
def add_TransactionVerificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TransactionVerification': grpc.unary_unary_rpc_method_handler(
                    servicer.TransactionVerification,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'verify.TransactionVerificationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('verify.TransactionVerificationService', rpc_method_handlers)
